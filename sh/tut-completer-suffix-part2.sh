...
#
# Script @completer from content/tutorials/naming/suffix-part2.md 
#
#----------------------------------------------------------------------#  Start 1
echo "Block 'newAuthorizer' (1/2 in completer) of content/tutorials/naming/suffix-part2.md"
####
 cat - <<EOF >$V_TUT/src/fortune/server/util/authorizer.go
package util
...
#----------------------------------------------------------------------#  Start 2
echo "Block 'buildServer' (2/2 in completer) of content/tutorials/naming/suffix-part2.md"
####
go install fortune/server
#----------------------------------------------------------------------#  End 2
