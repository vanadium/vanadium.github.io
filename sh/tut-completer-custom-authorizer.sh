...
#
# Script @completer from content/tutorials/security/custom-authorizer.md 
#
#----------------------------------------------------------------------#  Start 1
echo "Block 'authorizerWithFriendWindow' (1/1 in completer) of content/tutorials/security/custom-authorizer.md"
####
 cat - <<EOF >$V_TUT/src/fortune/server/util/authorizer.go
package util
